...
# Function: Facial Analysis, displays informaiton about: age, gender, emotion, and race
...
# Analyzes the facial characteristics of the image (image1), this is where most of the processing happens
# Note: The output is stored in a nested dictionary embedded in a list
verifyResults = DeepFace.analyze(img_path = imagePath1, actions = ["age", "gender", "emotion", "race"])
...
for key, value in outputResults.items():
  print("-",key,"=",value)
#print(verifyResults[0]["age"]," years old ",verifyResults[0]["dominant_race"]," ",verifyResults[0]["dominant_emotion"]," ", verifyResults[0]["gender"])
